...
<div class="container-fluid">
  <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="row">
    ...
    <div class="mb-3 col-12 col-md-10">
      ...
      <input type="text" class="form-control" id="productName" placeholder="Masukkan nama barang" name="name" value="{{ old('name') }}">
      @if($errors->has('name'))
    ...
    <div class="mb-3 col-12 col-md-4">
      ...
      <input type="number" class="form-control" id="purchasePrice" placeholder="Masukkan harga beli" name="purchase_price" value="{{ old('purchase_price') }}">
    ...
    <div class="mb-3 col-12 col-md-4">
      ...
      <input type="number" class="form-control" id="sellPrice" placeholder="Masukkan harga jual" name="sell_price" value="{{ old('sell_price') }}">
    ...
    <div class="mb-3 col-12 col-md-4">
      ...
      <input type="number" class="form-control" id="productStock" placeholder="Masukkan stok barang" name="stock" value="{{ old('stock') }}">
      @if($errors->has('stock'))
        ...
        <div class="img-input-wrapper">
          ...
          <div class="d-flex flex-column justify-content-center">
            <div class="d-flex justify-content-center">
              <img id="frame" src="{{ asset('storage/assets/Image-placeholder.png') }}" class="img-placeholder" alt="Image Preview" />
            </div>
            <p id="img-text-placeholder" class="img-text-placeholder mt-2 text-primary">Upload gambar di sini</p>
          </div>
        </div>
        @if($errors->has('image'))
    ...
    <div class="d-flex gap-1 justify-content-end">
      <button class="btn border-primary text-primary px-5" type="reset">Batalkan</button>
      <button class="btn btn-primary px-5" type="submit" onclick="return confirm('Apakah kamu yakin?')">Simpan</button>
    </div>
  </form>
</div>
